...
export const listV2Sites=(tenantId?:string)=>json<V2Site[]>(withTenant("/api/v2/sites/",tenantId));
...
export const listV2Domains=(tenantId?:string)=>json<V2Domain[]>(withTenant("/api/v2/domains/",tenantId));
export const listV2QRCodes=(tenantId?:string)=>json<V2QRCode[]>(withTenant("/api/v2/qr-codes/",tenantId));
